...
async function createHolosphereModule(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('holosphere_wasm.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('holosphere_wasm.wasm', import.meta.url).href;
...
export default createHolosphereModule;
